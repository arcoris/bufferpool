...
// partition_budget_publication.go owns partition budget publication. These
// helpers may mutate partition runtime policy, Pool class budgets, and dirty
// markers through prevalidated plans; pure target allocation remains in
// partition_budget_allocator.go.
